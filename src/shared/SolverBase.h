...
public:
    ...
    virtual void make_boundaryLS(DataArray2d Udata, FaceIdType faceId);
    virtual void make_boundaryLSC(DataArray2d Udata, FaceIdType faceId);
    virtual void make_boundaryGradPhi(DataArray2d Udata, FaceIdType faceId);
    virtual void make_boundary(DataArray3d Udata, FaceIdType faceId);

    virtual void make_boundaries_LS_serial(DataArray2d Udata);
    virtual void make_boundaries_LSC_serial(DataArray2d Udata);
    virtual void make_boundaries_GradPhi_serial(DataArray2d Udata);

    virtual void make_boundaries_LS_serial(DataArray3d Udata);
    virtual void make_boundaries_LSC_serial(DataArray3d Udata);
    virtual void make_boundaries_GradPhi_serial(DataArray3d Udata);
