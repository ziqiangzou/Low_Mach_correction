...
enum VarIndex
{
    ...
    IS=2,
    IH=2,
    IU=3,   /*!< X velocity / momentum index */
    IV=4,   /*!< Y velocity / momentum index */
    IW=5,   /*!< Z velocity / momentum index */

    IA=6,   /*!< X magnetic field index */
    IB=7,   /*!< Y magnetic field index */
    IC=8,   /*!< Z magnetic field index */
    IBX=6,  /*!< X magnetic field index */
    IBY=7,  /*!< Y magnetic field index */
    IBZ=8,   /*!< Z magnetic field index */
    IBFX = 0,
    IBFY = 1,
    IBFZ = 2
};
...
enum RiemannSolverType
{
    ...
    RIEMANN_HLL,    /*!< HLL hydro Riemann solver */
