...
public:
    ...
    void save()
    {
        ...
        // write density
        hid_t dataset_id = H5Dcreate2(file_id, variables_names[ID].c_str(), dataType, dataspace_file,
        ...
        // write total energy
        dataset_id = H5Dcreate2(file_id, variables_names[IE].c_str(), dataType, dataspace_file,
                                H5P_DEFAULT, propList_create_id, H5P_DEFAULT);
        copy_buffer(data, isize, jsize, ksize, IP, layout);
        status = H5Dwrite(dataset_id, dataType, dataspace_memory, dataspace_file, H5P_DEFAULT, data);

        // write momentum X
        dataset_id = H5Dcreate2(file_id, variables_names[IU].c_str(), dataType, dataspace_file,
                                H5P_DEFAULT, propList_create_id, H5P_DEFAULT);
        copy_buffer(data, isize, jsize, ksize, IU, layout);
        status = H5Dwrite(dataset_id, dataType, dataspace_memory, dataspace_file, H5P_DEFAULT, data);

        // write momentum Y
        dataset_id = H5Dcreate2(file_id, variables_names[IV].c_str(), dataType, dataspace_file,
                                H5P_DEFAULT, propList_create_id, H5P_DEFAULT);
        ...
        if (dimType == THREE_D) {
            dataset_id = H5Dcreate2(file_id, variables_names[IW].c_str(), dataType, dataspace_file,
                                    H5P_DEFAULT, propList_create_id, H5P_DEFAULT);
...
public:
    ...
    void save()
    {
         ...
         * write density
         */
        dataset_id = H5Dcreate2(file_id, variables_names[ID].c_str(), dataType, dataspace_file,
                                H5P_DEFAULT, propList_create_id, H5P_DEFAULT);
        copy_buffer(data, isize, jsize, ksize, ID, layout);
...
public:
    ...
    Load_HDF5(DataArray     Udata,
              ...
              int nbvar,
              const std::map<int, std::string>& variables_names) :
        Udata(Udata), Uhost(Udata), params(params), configMap(configMap),
        nbvar(nbvar), variables_names(variables_names),
    ...
    virtual void load(std::string filename)
    {
        ...
        // read density
        dataset_id = H5Dopen2(file_id, variables_names[ID].c_str(), H5P_DEFAULT);
        ...
        // read energy
        dataset_id = H5Dopen2(file_id, variables_names[IE].c_str(), H5P_DEFAULT);
        status = H5Dread(dataset_id, dataType, dataspace_memory, dataspace_file,
                         H5P_DEFAULT, data);
        H5Dclose(dataset_id);
        ...
        // read momentum X
        dataset_id = H5Dopen2(file_id, variables_names[IU].c_str(), H5P_DEFAULT);
        status = H5Dread(dataset_id, dataType, dataspace_memory, dataspace_file,
                         H5P_DEFAULT, data);
        H5Dclose(dataset_id);
        copy_buffer(data, isize, jsize, ksize, IU, layout);
        ...
        // read momentum Y
        dataset_id = H5Dopen2(file_id, variables_names[IV].c_str(), H5P_DEFAULT);
        status = H5Dread(dataset_id, dataType, dataspace_memory, dataspace_file,
                         H5P_DEFAULT, data);
        H5Dclose(dataset_id);
        copy_buffer(data, isize, jsize, ksize, IV, layout);
        ...
        if (dimType == THREE_D) {
            dataset_id = H5Dopen2(file_id, variables_names[IW].c_str(), H5P_DEFAULT);
            status = H5Dread(dataset_id, dataType, dataspace_memory, dataspace_file,
                             H5P_DEFAULT, data);
            H5Dclose(dataset_id);
            copy_buffer(data, isize, jsize, ksize, IW, layout);
...
public:
    ...
    void load(std::string filename)
    {
        ...
        // read density
        dataset_id = H5Dopen2(file_id, this->variables_names[ID].c_str(), H5P_DEFAULT);
        status = H5Dread(dataset_id, dataType, dataspace_memory, dataspace_file,
                         H5P_DEFAULT, data);
        H5Dclose(dataset_id);
        ...
        // read energy
        dataset_id = H5Dopen2(file_id, this->variables_names[IE].c_str(), H5P_DEFAULT);
        status = H5Dread(dataset_id, dataType, dataspace_memory, dataspace_file,
                         H5P_DEFAULT, data);
        H5Dclose(dataset_id);
        ...
        // read momentum X
        dataset_id = H5Dopen2(file_id, this->variables_names[IU].c_str(), H5P_DEFAULT);
        status = H5Dread(dataset_id, dataType, dataspace_memory, dataspace_file,
                         H5P_DEFAULT, data);
        H5Dclose(dataset_id);
        ...
        // read momentum Y
        dataset_id = H5Dopen2(file_id, this->variables_names[IV].c_str(), H5P_DEFAULT);
        status = H5Dread(dataset_id, dataType, dataspace_memory, dataspace_file,
                         H5P_DEFAULT, data);
        H5Dclose(dataset_id);
        ...
        // read momentum Z (only if hydro 3D)
        if (dimType == THREE_D) {
            dataset_id = H5Dopen2(file_id, this->variables_names[IW].c_str(), H5P_DEFAULT);
            status = H5Dread(dataset_id, dataType, dataspace_memory, dataspace_file,
                             H5P_DEFAULT, data);
            H5Dclose(dataset_id);
