                                  ...
                                  std::string debug_name)
{
    ...
    {
#ifdef USE_MPI
        save_VTK_2D_mpi(Udata, Uhost, params, configMap, HYDRO_2D_NBVAR, variables_names, iStep, debug_name);
#else
        save_VTK_2D(Udata, Uhost, params, configMap, HYDRO_2D_NBVAR, variables_names, iStep, debug_name);
#endif // USE_MPI
    }
    ...
    if (hdf5_enabled)
    {
        ...
        writer.save();
        writeXdmfForHdf5Wrapper(params, configMap, iStep, variables_names, false);
#else
                                  ...
                                  std::string debug_name)
{
    ...
    {
#ifdef USE_MPI
        save_VTK_3D_mpi(Udata, Uhost, params, configMap, HYDRO_3D_NBVAR, variables_names, iStep, debug_name);
#else
        save_VTK_3D(Udata, Uhost, params, configMap, HYDRO_3D_NBVAR, variables_names, iStep, debug_name);
#endif // USE_MPI
    }
